...
if(GMOCK_INCLUDE_DIRS AND GMOCK_LIBRARIES AND GMOCK_MAIN_LIBRARIES)
  ...
  if(GMOCK_PREFIX)
    ...
    find_path(_GMOCK_INCLUDE_DIR gmock/gmock.h
		  PATHS 
		    "c:/prj/libs/gmock-1.5.0/include")
    find_library(_GMOCK_LIBRARY gmock
			PATHS 
			  "c:/prj/libs/gmock-1.5.0/lib/${CMAKE_BUILD_TYPE}" )
    find_library(_GMOCK_MAIN_LIBRARY gmock_main
			PATHS 
			  "c:/prj/libs/gmock-1.5.0/lib/${CMAKE_BUILD_TYPE}" )
  endif(GMOCK_PREFIX)
...
unset(_GMOCK_INCLUDE_DIR CACHE)
unset(_GMOCK_LIBRARY CACHE)
unset(_GMOCK_MAIN_LIBRARY CACHE)
