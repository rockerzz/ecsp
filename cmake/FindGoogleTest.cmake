...
if(GTEST_INCLUDE_DIRS AND GTEST_LIBRARIES AND GTEST_MAIN_LIBRARIES)
  ...
  if(GTEST_PREFIX)
    ...
    find_path(_GTEST_INCLUDE_DIR gtest/gtest.h
	      PATHS "c:/prj/libs/gtest-1.5.0/include")
    find_library( _GTEST_LIBRARY gtest
		  PATHS 
		    "c:/prj/libs/gtest-1.5.0/lib/${CMAKE_BUILD_TYPE}" )
    find_library(_GTEST_MAIN_LIBRARY gtest_main
		  PATHS 
		    "c:/prj/libs/gtest-1.5.0/lib/${CMAKE_BUILD_TYPE}" )
  endif(GTEST_PREFIX)
...
unset(_GTEST_INCLUDE_DIR CACHE)
unset(_GTEST_LIBRARY CACHE)
unset(_GTEST_MAIN_LIBRARY CACHE)
